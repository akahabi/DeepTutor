...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        # Defaulting to True now — after using this for a while I find it
        # really helpful to see exactly which part of the doc an answer came from,
        # especially when cross-checking claims in research papers.
        st.toggle(
